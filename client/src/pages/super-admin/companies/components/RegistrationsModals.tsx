...
interface CreateCompanyModalProps {
  ...
  onFormChange: (
    updater: (prev: CreateCompanyInput) => CreateCompanyInput,
  ) => void;
  loading: boolean;
    ...
    >
      <FormField label="Company name" htmlFor="create-companyName">
        <Input
          ...
          onChange={(e) =>
            onFormChange((f) => ({ ...f, companyName: e.target.value }))
          }
...
export const EditCompanyModal = ({
  ...
  return (
    <FormModal
      ...
      title="Edit company"
      description={
        target ? `Update details for ${target.companyName}.` : undefined
      }
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <FormField label="Admin last name" htmlFor="edit-lastName">
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, adminLastName: e.target.value }))
                }
                icon={<HiUser className="h-4 w-4 text-brand-600" />}
              />
            </FormField>
          ...
          <FormField label="Admin email" htmlFor="edit-email">
            <Input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, adminEmail: e.target.value }))
              }
              required
              icon={<HiEnvelope className="h-4 w-4 text-brand-600" />}
            />
