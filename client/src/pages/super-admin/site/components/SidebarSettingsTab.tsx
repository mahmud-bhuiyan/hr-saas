    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <FormField label="Sidebar mode" htmlFor="sidebarBehavior">
        <Select
          ...
          onChange={(e) =>
            onChange("sidebarBehavior", e.target.value as SidebarBehavior)
          }
      ...
      {values.sidebarBehavior === "fixed_collapsed" && (
        <FormField
          label="Compact sidebar width (80–128 px)"
          htmlFor="sidebarCollapsedWidthPx"
        >
          <Input
            ...
            onChange={(e) =>
              onChange("sidebarCollapsedWidthPx", Number(e.target.value))
            }
      ...
      {values.sidebarBehavior === "collapsible" && (
        <FormField
          label="Expanded sidebar width (160–320 px)"
          htmlFor="sidebarExpandedWidthPx"
        >
          <Input
            ...
            onChange={(e) =>
              onChange("sidebarExpandedWidthPx", Number(e.target.value))
            }
            icon={<HiArrowsPointingOut className="h-4 w-4 text-brand-600" />}
            disabled={loading}
          />
