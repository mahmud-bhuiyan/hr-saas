...
export const SITE_SETTINGS_BASE_PATH = "/super-admin/site";
export const SITE_SETTINGS_GENERAL_PATH = "/super-admin/site/general";
export const SITE_SETTINGS_LOGO_PATH = "/super-admin/site/logo";
export const SITE_SETTINGS_FAVICON_PATH = "/super-admin/site/favicon";
export const SITE_SETTINGS_SIDEBAR_PATH = "/super-admin/site/sidebar";

export const SITE_SETTINGS_TAB_PATHS: Record<SiteSettingsTab, string> = {
  general: SITE_SETTINGS_GENERAL_PATH,
  logo: SITE_SETTINGS_LOGO_PATH,
  favicon: SITE_SETTINGS_FAVICON_PATH,
  sidebar: SITE_SETTINGS_SIDEBAR_PATH,
};
...
export const siteSettingsTabFromPathname = (
  pathname: string,
): SiteSettingsTab | null => {
  if (pathname.startsWith(SITE_SETTINGS_LOGO_PATH)) {
    return "logo";
  }
  if (pathname.startsWith(SITE_SETTINGS_FAVICON_PATH)) {
    return "favicon";
  }
  if (pathname.startsWith(SITE_SETTINGS_SIDEBAR_PATH)) {
    return "sidebar";
  }
  if (pathname.startsWith(SITE_SETTINGS_GENERAL_PATH)) {
    return "general";
  }
  return null;
};
...
export const toTabPatchInput = (
  ...
  if (logoDisplayChanged) {
    ...
    if (changed.logoObjectFit !== undefined) {
      input.logoDisplay.objectFit =
        changed.logoObjectFit as SiteSettingsFormValues["logoObjectFit"];
    }
    if (changed.logoShape !== undefined) {
      input.logoDisplay.shape =
        changed.logoShape as SiteSettingsFormValues["logoShape"];
    }
  ...
  if (sidebarDisplayChanged) {
    ...
    if (changed.sidebarBehavior !== undefined) {
      input.sidebarDisplay.behavior =
        changed.sidebarBehavior as SiteSettingsFormValues["sidebarBehavior"];
    }
    if (changed.sidebarCollapsedWidthPx !== undefined) {
      input.sidebarDisplay.collapsedWidthPx = Number(
        changed.sidebarCollapsedWidthPx,
      );
    }
    if (changed.sidebarExpandedWidthPx !== undefined) {
      input.sidebarDisplay.expandedWidthPx = Number(
        changed.sidebarExpandedWidthPx,
      );
    }
  }
