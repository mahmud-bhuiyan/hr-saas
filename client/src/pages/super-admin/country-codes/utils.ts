...
export const COUNTRY_CODES_BASE_PATH = "/super-admin/country-codes";
export const COUNTRY_CODES_ACTIVE_PATH = "/super-admin/country-codes/active";
export const COUNTRY_CODES_ARCHIVED_PATH =
  "/super-admin/country-codes/archived";
