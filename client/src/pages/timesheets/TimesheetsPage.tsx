...
export const TimesheetsPage = () => {
  ...
  const canAccess =
    user &&
    TENANT_TIMESHEET_ROLES.includes(
      user.role as (typeof TENANT_TIMESHEET_ROLES)[number],
    );
  ...
  const saveMutation = useMutation({
    ...
    onError: (error: unknown) => {
      toast.error(
        error instanceof ApiError ? error.message : "Failed to save timesheet",
      );
    },
  });
  ...
  const showTabs = Boolean(canApprove);
  ...
  return (
    <PageContainer>
      ...
      {(!showTabs || activeTab === "my-timesheet") && (
        <div className="space-y-6">
          {missingEmployeeLink ? (
            <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
              ...
              <p className="mt-1">
                Timesheets are tied to employee records. Contact your
              ...
              <div className="card-surface flex flex-wrap items-center justify-between gap-3 px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    onClick={() =>
                      setWeekOf((current) => shiftWeek(current, -1))
                    }
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setWeekOf(formatWeekOf(getMondayOfWeek(new Date())))
                    }
                  >
                    This week
                  </Button>
