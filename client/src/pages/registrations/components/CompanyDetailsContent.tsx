  ...
  return (
    <dl className="divide-y divide-slate-100">
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        ...
        <dd className="text-right font-medium text-slate-900">{company.companyName}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
      ...
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        ...
        <dd className="text-right font-medium text-slate-900">{company.adminEmail}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        <dt className="text-slate-500">Approval status</dt>
        <dd className="text-right font-medium capitalize text-slate-900">{company.status}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
      ...
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        ...
        <dd className="text-right text-slate-900">{formatDate(company.submittedAt)}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        <dt className="text-slate-500">Created by</dt>
        <dd className="text-right text-slate-900">{company.createdByName ?? '—'}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        <dt className="text-slate-500">Updated by</dt>
        <dd className="text-right text-slate-900">{company.updatedByName ?? '—'}</dd>
      </div>
      <div className="flex justify-between gap-4 py-2.5 text-sm">
      ...
      <div className="flex justify-between gap-4 py-2.5 text-sm">
        ...
        <dd className="text-right font-mono text-xs text-slate-600">{company.tenantId}</dd>
      </div>
      {company.rejectedReason && (
        <div className="flex justify-between gap-4 py-2.5 text-sm">
          <dt className="text-slate-500">Rejection reason</dt>
          <dd className="max-w-[60%] text-right text-slate-900">{company.rejectedReason}</dd>
        </div>
      )}
    </dl>
  );
