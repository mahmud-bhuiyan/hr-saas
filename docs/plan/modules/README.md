...
## Demo 1 modules (create these first)

| # | Module | File | Status |
|---|--------|------|--------|
| 01 | Auth & Tenant | [01-auth-tenant.md](./01-auth-tenant.md) | To do |
| 02 | Employee Management | [02-employees.md](./02-employees.md) | To do |
| 03 | Leave & Absence | [03-leave.md](./03-leave.md) | To do |
| 04 | Document Storage | [04-documents.md](./04-documents.md) | To do |
| 05 | Admin & Settings | [05-admin-settings.md](./05-admin-settings.md) | To do |
...
4. Update the Status column in this README when a plan is ready for development.
